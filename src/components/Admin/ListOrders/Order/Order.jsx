...
const Order = () => {
    ...
    const getOrderDetails = async () => {
        const response  = await fetch(`https://transport-service.somee.com/getOrderDetails?orderId=${Number(orderId)}`,{
            method:"GET",
        })
    ...
    const deleteCarrierUser = async () => {
        const response = await fetch(`https://transport-service.somee.com/changeOrderAdmin`,{
            method: "POST",
            headers: {
